...
const (
	...
	// SQLKEYWORD is a generic SQL keyword used only for uppercasing.
	// The parser does not create segments for this type.
	SQLKEYWORD
)
...
var keywordMap = map[string]TokenType{
	...
	/*
	 * Generic SQL keywords (uppercased, no parser segments)
	 */
	"DEFAULT":       SQLKEYWORD,
	"CHECK":         SQLKEYWORD,
	"CONSTRAINT":    SQLKEYWORD,
	"REFERENCES":    SQLKEYWORD,
	"UNIQUE":        SQLKEYWORD,
	"INDEX":         SQLKEYWORD,
	"VIEW":          SQLKEYWORD,
	"REPLACE":       SQLKEYWORD,
	...
	"RESTRICT":      SQLKEYWORD,
	"FOREIGN":       SQLKEYWORD,
	"GENERATED":     SQLKEYWORD,
	"ALWAYS":        SQLKEYWORD,
	"IDENTITY":      SQLKEYWORD,
	"SEQUENCE":      SQLKEYWORD,
	"SCHEMA":        SQLKEYWORD,
	"EXTENSION":     SQLKEYWORD,
	"ENUM":          SQLKEYWORD,
	"TRIGGER":       SQLKEYWORD,
	"PROCEDURE":     SQLKEYWORD,
	"GRANT":         SQLKEYWORD,
	"REVOKE":        SQLKEYWORD,
	"PRIVILEGES":    SQLKEYWORD,
	"TEMPORARY":     SQLKEYWORD,
	"TEMP":          SQLKEYWORD,
	"ONLY":          SQLKEYWORD,
	"WITHOUT":       SQLKEYWORD,
	"ROWID":         SQLKEYWORD,
	"AUTOINCREMENT": SQLKEYWORD,
	"CONCURRENTLY":  SQLKEYWORD,
	"ENABLE":        SQLKEYWORD,
	"DISABLE":       SQLKEYWORD,
	"RULE":          SQLKEYWORD,
	"POLICY":        SQLKEYWORD,
	"INHERIT":       SQLKEYWORD,
	"NOINHERIT":     SQLKEYWORD,
	"TABLESPACE":    SQLKEYWORD,
	"COMMENT":       SQLKEYWORD,
	"NO":            SQLKEYWORD,
	"ACTION":        SQLKEYWORD,
	"DEFERRABLE":    SQLKEYWORD,
	"DEFERRED":      SQLKEYWORD,
	"IMMEDIATE":     SQLKEYWORD,
	"INITIALLY":     SQLKEYWORD,
	"STRICT":        SQLKEYWORD,
	"VOLATILE":      SQLKEYWORD,
	"STABLE":        SQLKEYWORD,
	"IMMUTABLE":     SQLKEYWORD,
	"LANGUAGE":      SQLKEYWORD,
	"RETURNS":       SQLKEYWORD,
	"SECURITY":      SQLKEYWORD,
	"DEFINER":       SQLKEYWORD,
