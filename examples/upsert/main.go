...
import (
	...
	"github.com/tkcrm/pgxgen/examples/upsert/models"
)
...
func main() {
	...
	id, err := pgClient.UpsertUser(ctx,
		...
		// If left nil like we are doing here, pgxgen will just use the primary key.
		nil,
		// This tells pgxgen to update all of the given fields in the event of a
	...
	ratingFieldSet := pgxgen.NewFieldSet(models.UserMaxFieldIndex)
