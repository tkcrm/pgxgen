...
var GrandparentAllFields pgxgen.FieldSet = pgxgen.NewFieldSetFilled(3)

var defaultableColsForGrandparent = func() pgxgen.FieldSet {
	fs := pgxgen.NewFieldSet(GrandparentMaxFieldIndex)
...
// For use as a 'fieldMask' parameter
var ParentAllFields pgxgen.FieldSet = pgxgen.NewFieldSetFilled(3)

var defaultableColsForParent = func() pgxgen.FieldSet {
	fs := pgxgen.NewFieldSet(ParentMaxFieldIndex)
...
// For use as a 'fieldMask' parameter
var ChildAllFields pgxgen.FieldSet = pgxgen.NewFieldSetFilled(3)

var defaultableColsForChild = func() pgxgen.FieldSet {
	fs := pgxgen.NewFieldSet(ChildMaxFieldIndex)
...
type DBQueries interface {
	...
	// Grandparent methods
	GetGrandparent(ctx context.Context, id int64, opts ...pgxgen.GetOpt) (*Grandparent, error)
	ListGrandparent(ctx context.Context, ids []int64, opts ...pgxgen.ListOpt) ([]Grandparent, error)
	InsertGrandparent(ctx context.Context, value *Grandparent, opts ...pgxgen.InsertOpt) (int64, error)
	BulkInsertGrandparent(ctx context.Context, values []Grandparent, opts ...pgxgen.InsertOpt) ([]int64, error)
	UpdateGrandparent(ctx context.Context, value *Grandparent, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpdateOpt) (ret int64, err error)
	UpsertGrandparent(ctx context.Context, value *Grandparent, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) (int64, error)
	BulkUpsertGrandparent(ctx context.Context, values []Grandparent, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) ([]int64, error)
	DeleteGrandparent(ctx context.Context, id int64, opts ...pgxgen.DeleteOpt) error
	BulkDeleteGrandparent(ctx context.Context, ids []int64, opts ...pgxgen.DeleteOpt) error
	GrandparentFillIncludes(ctx context.Context, rec *Grandparent, includes *include.Spec, opts ...pgxgen.IncludeOpt) error
	GrandparentBulkFillIncludes(ctx context.Context, recs []*Grandparent, includes *include.Spec, opts ...pgxgen.IncludeOpt) error

	// Parent methods
	GetParent(ctx context.Context, id int64, opts ...pgxgen.GetOpt) (*Parent, error)
	ListParent(ctx context.Context, ids []int64, opts ...pgxgen.ListOpt) ([]Parent, error)
	InsertParent(ctx context.Context, value *Parent, opts ...pgxgen.InsertOpt) (int64, error)
	BulkInsertParent(ctx context.Context, values []Parent, opts ...pgxgen.InsertOpt) ([]int64, error)
	UpdateParent(ctx context.Context, value *Parent, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpdateOpt) (ret int64, err error)
	UpsertParent(ctx context.Context, value *Parent, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) (int64, error)
	BulkUpsertParent(ctx context.Context, values []Parent, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) ([]int64, error)
	DeleteParent(ctx context.Context, id int64, opts ...pgxgen.DeleteOpt) error
	BulkDeleteParent(ctx context.Context, ids []int64, opts ...pgxgen.DeleteOpt) error
	ParentFillIncludes(ctx context.Context, rec *Parent, includes *include.Spec, opts ...pgxgen.IncludeOpt) error
	ParentBulkFillIncludes(ctx context.Context, recs []*Parent, includes *include.Spec, opts ...pgxgen.IncludeOpt) error

	// Child methods
	GetChild(ctx context.Context, id int64, opts ...pgxgen.GetOpt) (*Child, error)
	ListChild(ctx context.Context, ids []int64, opts ...pgxgen.ListOpt) ([]Child, error)
	InsertChild(ctx context.Context, value *Child, opts ...pgxgen.InsertOpt) (int64, error)
	BulkInsertChild(ctx context.Context, values []Child, opts ...pgxgen.InsertOpt) ([]int64, error)
	UpdateChild(ctx context.Context, value *Child, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpdateOpt) (ret int64, err error)
	UpsertChild(ctx context.Context, value *Child, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) (int64, error)
	BulkUpsertChild(ctx context.Context, values []Child, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) ([]int64, error)
	DeleteChild(ctx context.Context, id int64, opts ...pgxgen.DeleteOpt) error
	BulkDeleteChild(ctx context.Context, ids []int64, opts ...pgxgen.DeleteOpt) error
	ChildFillIncludes(ctx context.Context, rec *Child, includes *include.Spec, opts ...pgxgen.IncludeOpt) error
	ChildBulkFillIncludes(ctx context.Context, recs []*Child, includes *include.Spec, opts ...pgxgen.IncludeOpt) error
