...
var FooAllFields pgxgen.FieldSet = pgxgen.NewFieldSetFilled(2)

var defaultableColsForFoo = func() pgxgen.FieldSet {
	fs := pgxgen.NewFieldSet(FooMaxFieldIndex)
...
type DBQueries interface {
	...
	// Foo methods
	GetFoo(ctx context.Context, id int64, opts ...pgxgen.GetOpt) (*Foo, error)
	ListFoo(ctx context.Context, ids []int64, opts ...pgxgen.ListOpt) ([]Foo, error)
	InsertFoo(ctx context.Context, value *Foo, opts ...pgxgen.InsertOpt) (int64, error)
	BulkInsertFoo(ctx context.Context, values []Foo, opts ...pgxgen.InsertOpt) ([]int64, error)
	UpdateFoo(ctx context.Context, value *Foo, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpdateOpt) (ret int64, err error)
	UpsertFoo(ctx context.Context, value *Foo, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) (int64, error)
	BulkUpsertFoo(ctx context.Context, values []Foo, constraintNames []string, fieldMask pgxgen.FieldSet, opts ...pgxgen.UpsertOpt) ([]int64, error)
	DeleteFoo(ctx context.Context, id int64, opts ...pgxgen.DeleteOpt) error
	BulkDeleteFoo(ctx context.Context, ids []int64, opts ...pgxgen.DeleteOpt) error
	FooFillIncludes(ctx context.Context, rec *Foo, includes *include.Spec, opts ...pgxgen.IncludeOpt) error
	FooBulkFillIncludes(ctx context.Context, recs []*Foo, includes *include.Spec, opts ...pgxgen.IncludeOpt) error
