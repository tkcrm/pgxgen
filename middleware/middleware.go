//
// Package middleware is used in pgxgen to add middleware to be executed
...
// any error is returned. This allows you to conveniantly translate pgxgen errors into the
...
func NewDBConnWrapper(dbConn pgxgen.DBConn) *DBConnWrapper {
