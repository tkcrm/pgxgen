...
- `github.com/opendoor/pgxgen/cmd/pgxgen` is a command line tool to be
  invoked in `go:generate` directives.
- `github.com/opendoor/pgxgen/gen` is the back end for the
  `github.com/opendoor/pgxgen/cmd/pgxgen` tool. All the command line
...
- `github.com/opendoor/pgxgen` and its subpackages (besides `cmd` and `gen`)
