...
// PGClient wraps either a 'sql.DB' or a 'sql.Tx'. All pgxgen-generated
// database access methods for this package are attached to it.
type PGClient struct {
	impl pgClientImpl
	topLevelDB pgxgen.DBConn
...
func NewPGClient(conn pgxgen.DBConn) *PGClient {
	client := PGClient {
		topLevelDB: conn,
	}
...
func (p *PGClient) Handle() pgxgen.DBHandle {
	return p.topLevelDB
}
...
func (tx *TxPGClient) Handle() pgxgen.DBHandle {
...
func (conn *ConnPGClient) Handle() pgxgen.DBHandle {
	return conn.impl.db
}
